...
class TPS_API UAbilityAsset : public UPrimaryDataAsset
{
	GENERATED_BODY()
public:
	UAbilityAsset(const FObjectInitializer &ObjectInitializer = FObjectInitializer::Get());

	// Grants the ability set to the specified ability system component.
	// The returned handles can be used later to take away anything that was granted.
	void GiveToAbilitySystem(UAbilitySystemComponent *ASC, FAbilitySet_GrantedHandles *OutGrantedHandles = nullptr, UObject *SourceObject = nullptr) const;
